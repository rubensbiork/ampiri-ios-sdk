...
class TableViewLocationControlAdDetailsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func loadClicked(sender: UIButton) {
        ...
        self.adapter = AmpiriSDK.sharedSDK().addLocationControlToTableView(tableView, parentViewController: self, adUnitId: "7f900c7d-7ce3-4190-8e93-310053e70ca2", templateType: self.templateSwitch.selectedSegmentIndex == 0 ? .InFeed : .ContentStream, templateCustomization: {
